...
@section('content')
    <div class="h-screen flex w-full justify-center items-center">
        ...
        <div class="h-fit w-1/3 flex flex-col rounded-xl bg-gradient-to-br from-gray-400 via-gray-700 to-gray-900 text-white items-center border-[10px] border-indigo-950">
            <h1 class="font-bold text-[30px] py-5">Update Data Lapangan</h1>
            <form action="{{route('admin.updatelapangan',$lapangans->id)}}" method="POST" class="text-black">
                @csrf
                <div class="w-full relative flex">
                    ...
                    <input type="number" name="no_lap" placeholder="Nomor Lapangan..." value = "{{$lapangans->no_lap}}"class="rounded-md px-2">
                </div>
                <div class="w-full relative flex mt-3">
                    ...
                    <input type="number" name="harga" placeholder="Harga Lapangan..." value = "{{$lapangans->harga}}" class="rounded-md px-2">
                </div>
